...
Adotar Node.js LTS, npm com lockfile, TypeScript em modo strict e módulos ESM. A CLI usa Commander; a configuração usa dotenv e Zod; logs estruturados usam Pino; a automação usa Playwright. ESLint, Prettier, Vitest e cobertura V8 formam a barreira de qualidade local e do GitHub Actions.
...
- Playwright aumenta o tamanho das dependências e da imagem, mas a imagem oficial reproduz browser e bibliotecas de sistema.
